...
<div class="clearfix"></div>
  ...
  <div class="card">
           <div class="card-body">
           <div class="card-title">{{__('dashboard.Add_Category')}}</div>
           <hr>
           ...
           <div class="form-group">
            ...
            <input type="text"  name="cat_name" class="form-control form-control-rounded" id="input-6" >
            @error('cat_name')
                 <span class="text-danger">{{$message}}</span>
             @enderror
             <label for="input-6">{{__('dashboard.Name_en')}}</label>
            <input type="text"  name="cat_name_en" class="form-control form-control-rounded" id="input-6">
           </div>
            @error('cat_name_en')
                 <span class="text-danger">{{$message}}</span>
             @enderror
           ...
           <div class="form-group" >
            ...
            <div class="form-group">
                ...
                <input type="file" id="file" name="cat_image" class="file image" >
   ...
   form_data.append("cat_image", document.getElementById('file').files[0]);
    ...
    $.ajax({
            ...
            success:function(response){
               ...
               $('#ImgOri').attr('src', "/images/category/"+'/'+response.path);
...
form_data.append('y1', y1.val());
    ...
    $.ajax({
            ...
            success:function(response){
               ...
               $('#ImgOri').attr('src', "/images/category/crop/"+'/'+response.path);
