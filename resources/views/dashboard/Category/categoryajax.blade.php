                ...
                success: function (response) {
                   console.log(response);
                    ...
                    $.each(response.category, function (key, item) {
                       ...
                       + "<td>" 
                       + item.cat_name + "</td><td>"
                       + item.cat_name_en + "</td><td>@if(auth()->user()->can('category-edit'))<button type='button' value='" + item.cat_id + "' class='btn btn-primary editbtn btn-sm'>Edit</button>@endif @if(auth()->user()->can('category-delete'))<button type='button' value='" + item.cat_id + "' class='btn btn-danger deletebtn btn-sm'>Delete</button>@endif</td>"
