				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					<div class="wrap-product-detail">
						<div class="detail-media">
							<div class="product-gallery">
							  <ul class="slides">
							    ...
							    <li >
							    	<img src="{{ asset('images/food/'.$product->foo_thumbnail) }}" alt="product thumbnail" />
							    </li>
						...
						<div class="detail-info">
                            ...
                            <h2 class="product-name">{{ $product->foo_info_en }}</h2>
                            ...
                            <div class="wrap-price"><span class="product-price">${{ $product->foo_price }}</span></div>
                            ...
                            <div class="quantity">
								...
								<div class="quantity-input">
									<input type="text" class="q" name="product-quatity" value="1" data-max="10" pattern="[0-9]*" >

                                    {{-- <input type="hidden" name="foo_id" value="{{ $product->foo_id }}" > --}}
							...
							<div class="wrap-butons">
								<button type="button" value="{{ $product->foo_id }}" class="addcart btn add-to-cart">Add to Cart</button>
                                {{-- </form> --}}
                                <div class="wrap-btn">
                                    <a href="#" class="btn btn-compare">Add Compare</a>
                                    <a href="#" class="addfav btn btn-wishlist" id="{{ $product->foo_id }}">Add Wishlist</a> 
                                </div>
							</div>
						</div> 
